...
.serch-box input{width: 620px;height: 46px;background-color: #fff;padding-left: 40px;box-sizing: border-box;font-size: 14px;border-radius: 2px 0 0 2px;}
